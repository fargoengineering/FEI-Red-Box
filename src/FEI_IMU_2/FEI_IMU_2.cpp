...
RunningAverage accel_avg_x(100);
RunningAverage accel_avg_y(100);
RunningAverage accel_avg_z(100);
RunningAverage gyro_avg_x(100);
RunningAverage gyro_avg_y(100);
RunningAverage gyro_avg_z(100);
...
void loop()
{
    ...
    accel_avg_x.addValue(accel.acceleration.x);
    accel_avg_y.addValue(accel.acceleration.y);
    accel_avg_z.addValue(accel.acceleration.z);

    gyro_avg_x.addValue(abs(gyro.gyro.x));
    gyro_avg_y.addValue(abs(gyro.gyro.y));
    gyro_avg_z.addValue(abs(gyro.gyro.z));
    ...
    gyro.gyro.y = (gyro.gyro.y * 57.2957795);
